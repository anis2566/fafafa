        ...
        <Document>
            <Page size="A4" style={{ border: "1px solid black", padding: "30px 20px" }}>
                ...
                <View style={{ margin: "30px 0" }}>
                    <View>
                        <Text>Bill To:</Text>
                        <View style={{ marginTop: "10px", gap: "2px" }}>
                            <Text style={{ fontSize: "14px" }}>{invoice.student.name}</Text>
                            <Text style={{ fontSize: "14px" }}>#{invoice.student.studentId}</Text>
                            <Text style={{ fontSize: "14px" }}>{invoice.class}</Text>
                        </View>
                    </View>
                    <View style={{ marginTop: "20px" }}>
                        <Text>Bill Month:</Text>
                        <Text style={{ fontSize: "14px", marginTop: "5px" }}>{invoice.month}</Text>
                    </View>
                </View>
                ...
                <View style={{ marginTop: "30px", alignItems: "flex-end" }}>
                    <View style={{ alignItems: "center" }}>
                        <Image
                            ...
                            style={{ height: "40px" }}
                        />
                        <Text style={{ fontSize: "14px" }}>Autohrity Signature</Text>
                    </View>
                </View>
            </Page>
        </Document>
